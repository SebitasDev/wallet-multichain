...
const stats = [
    ...
    { value: "100%", label: { es: "Código abierto", en: "Open source" }, color: "#FF007A" },
];
        ...
        <Box id="features" sx={{ py: { xs: 6, md: 10 }, background: "#f5f5f5", borderTop: "3px solid #000000" }}>
            <Container maxWidth="lg">
                ...
                <Grid container spacing={3} sx={{ mt: 2 }}>
                    {features.map((f) => (
                        <Grid size={{ xs: 12, md: 6, lg: 4 }} key={f.title.en}>
                            <Card
                                sx={{
                                    height: "100%",
                                    background: "#ffffff",
            ...
            <Container maxWidth="lg">
                ...
                <Grid container spacing={3} sx={{ mt: 2 }}>
                    {useCases.map((useCase) => (
                        <Grid size={{ xs: 12, md: 6 }} key={useCase.title.en}>
                            <Card
                                sx={{
                                    height: "100%",
                                    background: "#ffffff",
